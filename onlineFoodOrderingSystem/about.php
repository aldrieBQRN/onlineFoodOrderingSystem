...
<body>
    ...
    <main class="container py-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <p>This section will contain information about the restaurant's history, mission, and values. It should
                    be engaging and reflect the quality of the food and service.</p>
