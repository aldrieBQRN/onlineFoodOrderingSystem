...
<body>
    ...
    <main class="container py-5">
        <div class="text-center py-5">
            ...
            <p class="text-muted">Draft page content for Contact Us.</p>
        </div>
            ...
            <div class="col-lg-6">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contactSubject" placeholder="e.g., Catering Inquiry" required>
                    </div>
                    <div class="mb-3">
                        <label for="contactMessage" class="form-label">Message</label>
                        <textarea class="form-control" id="contactMessage" rows="4" required></textarea>
                    </div>
                    <button type="submit" class="btn btn-theme w-100 py-2 rounded-pill">Send Message</button>
                </form>

                <div class="mt-5 text-center">
                    <h5 class="fw-bold">Visit Us</h5>
                    <p class="mb-0">123 Lomi Street, Sample City, Philippines</p>
                    <p>Open: Mon - Sun | 10:00 AM - 10:00 PM</p>
                    <div class="alert alert-info mt-4" role="alert">
                        This is a **draft page**. A map integration and actual contact details will be added here later.
                    </div>
                </div>
            </div>
        </div>
