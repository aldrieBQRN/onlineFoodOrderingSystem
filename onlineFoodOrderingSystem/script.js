      ...
      fetch("login.php", {
        ...
        .catch((error) => {
          ...
          if (messageDiv) {
            ...
            messageDiv.classList.add("alert-danger");
            messageDiv.textContent = "A network error occurred during login.";
          }
        });
    });
  }
          ...
          categoryHTML += `
            ...
            item.item_name
                                ...
                                <div class="card-body text-center">
                                    ...
                                    ${
                                      item.badge
                                        ? `<span class="badge badge-theme mb-2">${item.badge}</span>`
                                        : ""
                                    }
                                    <p class="card-text fs-5 fw-semibold">₱${parseFloat(
                                      item.price
                                    ).toFixed(2)}</p>
